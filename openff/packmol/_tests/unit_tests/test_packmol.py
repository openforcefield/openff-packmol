"""
Units tests for openff.packmol._packmol
"""
...
from openff.packmol._tests import MoleculeWithConformer
...
class TestPackmolWrapper:
    ...
    def test_trim_zero_molecules(self, caffeine, water, aspirin, ethanol):
        """
        ...
        """
        topology = pack_box(
            molecules=[caffeine, aspirin, water, ethanol],
